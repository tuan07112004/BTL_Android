...
public class AmLoaiSpAdapter  extends BaseAdapter {
    List<LoaiSp> array;
    Context context;

    public AmLoaiSpAdapter( Context context,List<LoaiSp> array) {
        this.array = array;
    ...
    public View getView(int i, View view, ViewGroup parent) {
        ...
        if (view == null){
            ...
            view = layoutInflater.inflate(R.layout.amitem_sanpham, null);
